...
/**
 * Generates a HTML file that displays the JDT AST extracted from a Java source
 * file.
 *
 * @author James Wasson
 * @author Eric Mercer
  ...
  private static String astNodeAsHtmlInner(ASTNode node) {
    ...
    for (Object obj : node.structuralPropertiesForType()) {
      ...
      if (descriptor instanceof SimplePropertyDescriptor) {
        ...
        // Ignore JavaDoc Property. JavaDoc is part of the AST and their children have
        // no value
