...
public class CastlingTests {
    ...
    public void castleWhite() {
        ...
        //set up king
        king = TestFactory.getNewPiece(ChessClasses.ChessGame.TeamColor.WHITE, ChessPiece.PieceType.KING);
        ...
        //set up game
        ChessClasses.ChessGame game = TestFactory.getNewGame();
        game.setBoard(board);
        ...
        Assertions.assertEquals(ChessClasses.ChessGame.TeamColor.WHITE, foundKing.getTeamColor(),
        ...
        Assertions.assertEquals(ChessClasses.ChessGame.TeamColor.WHITE, foundRook.getTeamColor(),
    ...
    public void castleBlack() {
        ...
        //set up king
        king = TestFactory.getNewPiece(ChessClasses.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.KING);
        ...
        ChessClasses.ChessGame game = TestFactory.getNewGame();
        game.setBoard(board);
        game.setTeamTurn(ChessClasses.ChessGame.TeamColor.BLACK);
        ...
        Assertions.assertEquals(ChessPiece.PieceType.KING, foundKing.getPieceType(),
                "Found piece at king's position is not a king");
        Assertions.assertEquals(ChessClasses.ChessGame.TeamColor.BLACK, foundKing.getTeamColor(),
                "Found piece at king's position is the wrong team color");
        ...
        Assertions.assertEquals(ChessPiece.PieceType.ROOK, foundRook.getPieceType(),
                "Found piece at rook's position is not a rook");
        Assertions.assertEquals(ChessClasses.ChessGame.TeamColor.BLACK, foundRook.getTeamColor(),
                "Found piece at rook's position is the wrong team color");
