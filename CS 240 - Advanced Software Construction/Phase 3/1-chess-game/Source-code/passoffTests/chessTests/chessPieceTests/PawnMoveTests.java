...
public class PawnMoveTests {
    ...
    private ChessClasses.ChessPiece pawn;
    ...
    public void emptyBoardWhite() {
        ...
        pawn = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.PAWN);
    ...
    public void emptyBoardBlack() {
        ...
        pawn = TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.PAWN);
        position = TestFactory.getNewPosition(4, 4);
        board.addPiece(position, pawn);
    ...
    public void edgePromotionWhite() {
        ...
        //add all promotions
        validMoves.add(TestFactory.getNewMove(start, end, ChessClasses.ChessPiece.PieceType.QUEEN));
        validMoves.add(TestFactory.getNewMove(start, end, ChessClasses.ChessPiece.PieceType.BISHOP));
        validMoves.add(TestFactory.getNewMove(start, end, ChessClasses.ChessPiece.PieceType.ROOK));
        validMoves.add(TestFactory.getNewMove(start, end, ChessClasses.ChessPiece.PieceType.KNIGHT));
    ...
    public void piecesInWayWhite() {
        ...
        board.addPiece(TestFactory.getNewPosition(5, 4),
                TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.KNIGHT));
    ...
    public void piecesInWayBlack() {
        ...
        board.addPiece(TestFactory.getNewPosition(3, 4),
                TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.ROOK));
    ...
    public void doubleMoveBlocked() {
        ...
        ChessClasses.ChessPiece whitePawn = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.PAWN);
        ChessPosition whitePosition = TestFactory.getNewPosition(2, 7);
        board.addPiece(whitePosition, whitePawn);

        ChessClasses.ChessPiece blackPawn = TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.PAWN);
    ...
    public void capturingByWhite() {
        ...
        board.addPiece(allyPosition, TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.KNIGHT));

        // enemy can capture left
        ChessPosition enemyPosition = TestFactory.getNewPosition(5, 3);
        board.addPiece(enemyPosition, TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.ROOK));
    ...
    public void capturingByBlack() {
        ...
        board.addPiece(allyPosition, TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.KNIGHT));

        // can capture right
        ChessPosition enemyPosition = TestFactory.getNewPosition(3, 5);
        board.addPiece(enemyPosition, TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.ROOK));
    ...
    public void pawnPromotionCapture() {
        ...
        board.addPiece(TestFactory.getNewPosition(1, 1),
                TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.KNIGHT));

        //capturing moves
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 1), ChessClasses.ChessPiece.PieceType.QUEEN));
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 1), ChessClasses.ChessPiece.PieceType.BISHOP));
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 1), ChessClasses.ChessPiece.PieceType.ROOK));
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 1), ChessClasses.ChessPiece.PieceType.KNIGHT));

        //straight to promotion moves
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 2), ChessClasses.ChessPiece.PieceType.KNIGHT));
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 2), ChessClasses.ChessPiece.PieceType.ROOK));
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 2), ChessClasses.ChessPiece.PieceType.BISHOP));
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 2), ChessClasses.ChessPiece.PieceType.QUEEN));
