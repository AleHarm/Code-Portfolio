...
public class RookMoveTests {
    ...
    private ChessClasses.ChessPiece rook;
    ...
    public void emptyBoard() {
        ...
        rook = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.ROOK);
    ...
    public void capture() {
        ...
        rook = TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.ROOK);
        ...
        board.addPiece(allyPiecePositions[0],
                TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.QUEEN));
        ...
        board.addPiece(enemyPiecePositions[0],
                TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.BISHOP));
