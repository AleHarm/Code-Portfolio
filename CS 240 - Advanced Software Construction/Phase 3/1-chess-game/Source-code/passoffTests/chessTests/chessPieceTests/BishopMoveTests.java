...
public class BishopMoveTests {
    ...
    private ChessClasses.ChessPiece bishop;
    ...
    public void bishopEmptyBoard() {
        ...
        bishop = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.BISHOP);
    ...
    public void bishopCapture() {
        ...
        bishop = TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.BISHOP);
        board.addPiece(position, bishop);
        ...
        board.addPiece(enemyPiecePositions[1],
                TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.QUEEN));
