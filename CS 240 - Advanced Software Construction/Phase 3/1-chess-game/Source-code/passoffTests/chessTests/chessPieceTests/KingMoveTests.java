...
public class KingMoveTests {
    ...
    private ChessClasses.ChessPiece king;
    ...
    public void kingEmptyBoard() {
        ...
        king = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.KING);
    ...
    public void kingCapture() {
        ...
        king = TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.KING);
