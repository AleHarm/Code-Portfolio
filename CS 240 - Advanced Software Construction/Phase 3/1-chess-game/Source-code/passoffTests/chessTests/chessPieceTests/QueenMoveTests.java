...
public class QueenMoveTests {
    ...
    private ChessClasses.ChessPiece queen;
    ...
    public void emptyBoard() {
        ...
        queen = TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.QUEEN);
    ...
    public void capture() {
        ...
        queen = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.QUEEN);
        ...
        board.addPiece(allyPiecePositions[0],
                TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.PAWN));
        board.addPiece(allyPiecePositions[1],
                TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.ROOK));
        ...
        board.addPiece(enemyPiecePositions[1],
                TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.PAWN));
        board.addPiece(enemyPiecePositions[2],
                TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.BISHOP));
