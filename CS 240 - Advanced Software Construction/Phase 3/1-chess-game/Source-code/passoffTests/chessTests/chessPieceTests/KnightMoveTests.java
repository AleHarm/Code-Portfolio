...
public class KnightMoveTests {
    ...
    private ChessClasses.ChessPiece knight;
    ...
    public void emptyBoard() {
		...
		| | | | | | | | |
         */
        knight = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessClasses.ChessPiece.PieceType.KNIGHT);
         ...
         */
        board = TestFactory.getNewBoard();
        knight = TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessClasses.ChessPiece.PieceType.KNIGHT);
        board.addPiece(position, knight);
