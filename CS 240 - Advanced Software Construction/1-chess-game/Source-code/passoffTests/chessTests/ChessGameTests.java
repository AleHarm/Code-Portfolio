...
public class ChessGameTests {
    ...
    public void validMoves() throws InvalidMoveException {
        ...
        board.addPiece(kingStartPosition, 
                TestFactory.getNewPiece(chess.ChessGame.TeamColor.WHITE, ChessPiece.PieceType.KING));

        ChessPosition queenStartPosition = TestFactory.getNewPosition(7, 8);
        board.addPiece(queenStartPosition, 
                TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.QUEEN));

        ChessPosition rookStartPosition = TestFactory.getNewPosition(1, 8);
        board.addPiece(rookStartPosition, 
                TestFactory.getNewPiece(chess.ChessGame.TeamColor.WHITE, ChessPiece.PieceType.ROOK));

        ChessPosition knightStartPosition = TestFactory.getNewPosition(6, 3);
        board.addPiece(knightStartPosition, 
                TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.KNIGHT));
        
        ChessPosition bishopStartPosition = TestFactory.getNewPosition(2, 3);
        board.addPiece(bishopStartPosition, 
                TestFactory.getNewPiece(chess.ChessGame.TeamColor.WHITE, ChessPiece.PieceType.BISHOP));

        ChessPosition pawnStartPosition = TestFactory.getNewPosition(6, 7);
        board.addPiece(pawnStartPosition, 
                TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.PAWN));

        game.setBoard(board);
        game.setTeamTurn(chess.ChessGame.TeamColor.WHITE);
        ...
        Assertions.assertEquals(chess.ChessGame.TeamColor.WHITE, king.getTeamColor(),
        ...
        Assertions.assertEquals(ChessPiece.PieceType.QUEEN, queen.getPieceType(),
                "Found piece at end position is not the correct piece type");
        Assertions.assertEquals(chess.ChessGame.TeamColor.BLACK, queen.getTeamColor(),
                "Found piece at end position is the wrong team color");
        ...
        Assertions.assertEquals(ChessPiece.PieceType.ROOK, rook.getPieceType(),
                "Found piece at end position is not the correct piece type");
        Assertions.assertEquals(chess.ChessGame.TeamColor.WHITE, rook.getTeamColor(),
                "Found piece at end position is the wrong team color");
        ...
        Assertions.assertEquals(ChessPiece.PieceType.KNIGHT, knight.getPieceType(),
                "Found piece at end position is not the correct piece type");
        Assertions.assertEquals(chess.ChessGame.TeamColor.BLACK, knight.getTeamColor(),
                "Found piece at end position is the wrong team color");
        ...
        Assertions.assertEquals(ChessPiece.PieceType.BISHOP, bishop.getPieceType(),
                "Found piece at end position is not the correct piece type");
        Assertions.assertEquals(chess.ChessGame.TeamColor.WHITE, bishop.getTeamColor(),
                "Found piece at end position is the wrong team color");
        ...
        Assertions.assertEquals(ChessPiece.PieceType.PAWN, pawn.getPieceType(),
                "Found piece at end position is not the correct piece type");
        Assertions.assertEquals(chess.ChessGame.TeamColor.BLACK, pawn.getTeamColor(),
                "Found piece at end position is the wrong team color");
    ...
    public void invalidMoves() throws InvalidMoveException {
        ...
        Assertions.assertFalse(game.isInCheck(chess.ChessGame.TeamColor.WHITE),
        ...
        Assertions.assertTrue(game.isInCheck(chess.ChessGame.TeamColor.WHITE),
    ...
    public void promotionMoves(ChessPiece.PieceType promotionType) throws InvalidMoveException {
        ...
        board.addPiece(TestFactory.getNewPosition(7, 3),
                TestFactory.getNewPiece(chess.ChessGame.TeamColor.WHITE, ChessPiece.PieceType.PAWN));
        board.addPiece(TestFactory.getNewPosition(2, 5),
                TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.PAWN));

        board.addPiece(TestFactory.getNewPosition(1, 6),
                TestFactory.getNewPiece(chess.ChessGame.TeamColor.WHITE, ChessPiece.PieceType.QUEEN));
        ...
        Assertions.assertEquals(promotionType, whiteEndPiece.getPieceType(),
                "Found piece at end position is not the correct piece type");
        Assertions.assertEquals(chess.ChessGame.TeamColor.WHITE, whiteEndPiece.getTeamColor(),
                "Found piece at end position is the wrong team color");
        ...
        Assertions.assertEquals(promotionType, blackEndPiece.getPieceType(),
                "Found piece at end position is not the correct piece type");
        Assertions.assertEquals(chess.ChessGame.TeamColor.BLACK, blackEndPiece.getTeamColor(),
                "Found piece at end position is the wrong team color");
    }
    ...
    public void whiteCheck() {
        ...
        board.addPiece(TestFactory.getNewPosition(8, 8),
                TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.KING));

        //threatening piece
        board.addPiece(TestFactory.getNewPosition(3, 6),
                TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.ROOK));
        ...
        Assertions.assertTrue(game.isInCheck(chess.ChessGame.TeamColor.WHITE),
                "White is in check but isInCheck returned false");
        Assertions.assertFalse(game.isInCheck(chess.ChessGame.TeamColor.BLACK),
    ...
    public void blackCheck() {
        ...
        Assertions.assertTrue(game.isInCheck(chess.ChessGame.TeamColor.BLACK),
    ...
    public void whiteTeamCheckmate() {
        ...
        board.addPiece(TestFactory.getNewPosition(3, 3),
                TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.ROOK));
        board.addPiece(TestFactory.getNewPosition(7, 3),
                TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.BISHOP));
        ...
        Assertions.assertTrue(game.isInCheckmate(chess.ChessGame.TeamColor.WHITE),
                "White is in checkmate but isInCheckmate returned false");
        Assertions.assertFalse(game.isInCheckmate(chess.ChessGame.TeamColor.BLACK),
    ...
    public void blackTeamPawnCheckmate() {
        ...
        Assertions.assertTrue(game.isInCheckmate(chess.ChessGame.TeamColor.BLACK),
                "Black is in checkmate but isInCheckmate returned false");
        Assertions.assertFalse(game.isInCheckmate(chess.ChessGame.TeamColor.WHITE),
    ...
    public void stalemate() {
        ...
        Assertions.assertTrue(game.isInStalemate(chess.ChessGame.TeamColor.WHITE),
                "White is in a stalemate but isInStalemate returned false");
        Assertions.assertFalse(game.isInStalemate(chess.ChessGame.TeamColor.BLACK),
    ...
    public class ValidMoveTests {
         ...
         */
            ...
            ChessPiece knight = TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.KNIGHT);
            ChessPosition knightPosition = TestFactory.getNewPosition(4, 3);
            board.addPiece(knightPosition, knight);

            ChessPiece queen = TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.QUEEN);
         ...
         */
            ...
            ChessPiece rook = TestFactory.getNewPiece(chess.ChessGame.TeamColor.WHITE, ChessPiece.PieceType.ROOK);
         ...
         */
            ...
            ChessPiece rook = TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.ROOK);
         ...
         */
            ...
            ChessPiece king = TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.KING);
            ...
            //team pieces
            //get pieces
            ChessPiece pawn = TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.PAWN);
            ChessPiece bishop = TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.BISHOP);
            ChessPiece queen = TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.QUEEN);
            ChessPiece knight = TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.KNIGHT);
            ChessPiece rook = TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.ROOK);
         ...
         */
            ...
            ChessPiece king = TestFactory.getNewPiece(chess.ChessGame.TeamColor.WHITE, ChessPiece.PieceType.KING);
