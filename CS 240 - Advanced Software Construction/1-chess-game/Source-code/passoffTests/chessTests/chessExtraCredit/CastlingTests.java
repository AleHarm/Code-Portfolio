...
public class CastlingTests {
    ...
    public void castleWhite() {
        ...
        //set up king
        king = TestFactory.getNewPiece(chess.ChessGame.TeamColor.WHITE, ChessPiece.PieceType.KING);
        ...
        //set up game
        chess.ChessGame game = TestFactory.getNewGame();
        game.setBoard(board);
        ...
        Assertions.assertEquals(chess.ChessGame.TeamColor.WHITE, foundKing.getTeamColor(),
        ...
        Assertions.assertEquals(chess.ChessGame.TeamColor.WHITE, foundRook.getTeamColor(),
    ...
    public void castleBlack() {
        ...
        //set up king
        king = TestFactory.getNewPiece(chess.ChessGame.TeamColor.BLACK, ChessPiece.PieceType.KING);
        ...
        Assertions.assertEquals(ChessPiece.PieceType.KING, foundKing.getPieceType(),
                "Found piece at king's position is not a king");
        Assertions.assertEquals(chess.ChessGame.TeamColor.BLACK, foundKing.getTeamColor(),
                "Found piece at king's position is the wrong team color");
        ...
        Assertions.assertEquals(ChessPiece.PieceType.ROOK, foundRook.getPieceType(),
                "Found piece at rook's position is not a rook");
        Assertions.assertEquals(chess.ChessGame.TeamColor.BLACK, foundRook.getTeamColor(),
                "Found piece at rook's position is the wrong team color");
