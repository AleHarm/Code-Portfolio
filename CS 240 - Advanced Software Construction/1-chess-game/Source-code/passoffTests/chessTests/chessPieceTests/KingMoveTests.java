...
public class KingMoveTests {
    ...
    public void kingEmptyBoard() {
        ...
        king = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, chess.ChessPiece.PieceType.KING);
    ...
    public void kingCapture() {
        ...
        king = TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, chess.ChessPiece.PieceType.KING);
