...
public class KnightMoveTests {
    ...
    private chess.ChessPiece knight;
    ...
    public void emptyBoard() {
		...
		| | | | | | | | |
         */
        knight = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, chess.ChessPiece.PieceType.KNIGHT);
         ...
         */
        board = TestFactory.getNewBoard();
        knight = TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, chess.ChessPiece.PieceType.KNIGHT);
        board.addPiece(position, knight);
