...
public class QueenMoveTests {
    ...
    private chess.ChessPiece queen;
    ...
    public void emptyBoard() {
        ...
        queen = TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, chess.ChessPiece.PieceType.QUEEN);
    ...
    public void capture() {
        ...
        queen = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, chess.ChessPiece.PieceType.QUEEN);
        ...
        board.addPiece(allyPiecePositions[0],
                TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, chess.ChessPiece.PieceType.PAWN));
        board.addPiece(allyPiecePositions[1],
                TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, chess.ChessPiece.PieceType.ROOK));
        ...
        board.addPiece(enemyPiecePositions[1],
                TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, chess.ChessPiece.PieceType.PAWN));
        board.addPiece(enemyPiecePositions[2],
                TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, chess.ChessPiece.PieceType.BISHOP));
