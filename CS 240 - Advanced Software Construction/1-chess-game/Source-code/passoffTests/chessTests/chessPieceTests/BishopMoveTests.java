...
public class BishopMoveTests {
    ...
    private chess.ChessPiece bishop;
    ...
    public void bishopEmptyBoard() {
        ...
        bishop = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, chess.ChessPiece.PieceType.BISHOP);
    ...
    public void bishopCapture() {
        ...
        bishop = TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, chess.ChessPiece.PieceType.BISHOP);
        board.addPiece(position, bishop);
        ...
        board.addPiece(enemyPiecePositions[1],
                TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, chess.ChessPiece.PieceType.QUEEN));
