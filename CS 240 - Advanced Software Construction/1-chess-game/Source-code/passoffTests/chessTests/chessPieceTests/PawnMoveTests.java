...
public class PawnMoveTests {
    ...
    public void emptyBoardWhite() {
        ...
        pawn = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, chess.ChessPiece.PieceType.PAWN);
    ...
    public void emptyBoardBlack() {
        ...
        pawn = TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, chess.ChessPiece.PieceType.PAWN);
        position = TestFactory.getNewPosition(4, 4);
        board.addPiece(position, pawn);
    ...
    public void edgePromotionWhite() {
        ...
        //add all promotions
        validMoves.add(TestFactory.getNewMove(start, end, chess.ChessPiece.PieceType.QUEEN));
        validMoves.add(TestFactory.getNewMove(start, end, chess.ChessPiece.PieceType.BISHOP));
        validMoves.add(TestFactory.getNewMove(start, end, chess.ChessPiece.PieceType.ROOK));
        validMoves.add(TestFactory.getNewMove(start, end, chess.ChessPiece.PieceType.KNIGHT));
    ...
    public void piecesInWayWhite() {
        ...
        board.addPiece(TestFactory.getNewPosition(5, 4),
                TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, chess.ChessPiece.PieceType.KNIGHT));
    ...
    public void piecesInWayBlack() {
        ...
        board.addPiece(TestFactory.getNewPosition(3, 4),
                TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, chess.ChessPiece.PieceType.ROOK));
    ...
    public void doubleMoveBlocked() {
        ...
        chess.ChessPiece whitePawn = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, chess.ChessPiece.PieceType.PAWN);
        ChessPosition whitePosition = TestFactory.getNewPosition(2, 7);
        board.addPiece(whitePosition, whitePawn);

        chess.ChessPiece blackPawn = TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, chess.ChessPiece.PieceType.PAWN);
    ...
    public void capturingByWhite() {
        ...
        board.addPiece(allyPosition, TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, chess.ChessPiece.PieceType.KNIGHT));

        // enemy can capture left
        ChessPosition enemyPosition = TestFactory.getNewPosition(5, 3);
        board.addPiece(enemyPosition, TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, chess.ChessPiece.PieceType.ROOK));
    ...
    public void capturingByBlack() {
        ...
        board.addPiece(allyPosition, TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, chess.ChessPiece.PieceType.KNIGHT));

        // can capture right
        ChessPosition enemyPosition = TestFactory.getNewPosition(3, 5);
        board.addPiece(enemyPosition, TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, chess.ChessPiece.PieceType.ROOK));
    ...
    public void pawnPromotionCapture() {
        ...
        board.addPiece(TestFactory.getNewPosition(1, 1),
                TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, chess.ChessPiece.PieceType.KNIGHT));

        //capturing moves
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 1), chess.ChessPiece.PieceType.QUEEN));
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 1), chess.ChessPiece.PieceType.BISHOP));
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 1), chess.ChessPiece.PieceType.ROOK));
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 1), chess.ChessPiece.PieceType.KNIGHT));

        //straight to promotion moves
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 2), chess.ChessPiece.PieceType.KNIGHT));
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 2), chess.ChessPiece.PieceType.ROOK));
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 2), chess.ChessPiece.PieceType.BISHOP));
        validMoves.add(TestFactory.getNewMove(position, TestFactory.getNewPosition(1, 2), chess.ChessPiece.PieceType.QUEEN));
